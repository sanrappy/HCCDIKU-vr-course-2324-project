...
public class LocomotionSampleSupport : MonoBehaviour
{
    ...
    public GameObject DistHandL;
    public GameObject DistHandR;
    ...
    public void Start()
    {
        ...
        DebugUIBuilder.instance.AddButton("Distance Grabbing", SetDistanceGrabbing);
        DebugUIBuilder.instance.AddButton("Restart Game", SetupTarget);
    ...
    */
    ...
    void SetDistanceGrabbing() 
    {
        print("Distance Grabbing enabled");
        HandL.SetActive(false);
        HandR.SetActive(false);

        DistHandL.SetActive(true);
        DistHandR.SetActive(true);
    }

    void SetNormalGrabbing() 
    {
        print("Distance Grabbing disabled");
        DistHandL.SetActive(false);
        DistHandR.SetActive(false);
